...
class appTestDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8362ae54f4265894ec7b29ee1345f8d8b550bf558a05559ddadc7bbf6de1ced9');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler((dirname(dirname(__DIR__)).'/logs/test.log'), 100, true);
    }
